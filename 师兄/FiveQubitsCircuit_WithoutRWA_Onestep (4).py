...
if __name__=='__main__':#fminbound
    ...
    ## Qubits frequency
    w_q = np.array([ 5.0 , 5.0 , 5.4 , 5.6 , 5.8 , 4.0 , 4.2 , 4.4 , 4.6 , 4.8 ]) * 2 * np.pi
...
#        ['Z','I','X','Y','Z'],
    ...
    if APRType==0:
#        psi0=tensor(basis(N,0), basis(3,1), (basis(3,1)+basis(3,0)).unit(), (basis(3,0)+basis(3,1)).unit(), basis(3,0) ,basis(3,1))
