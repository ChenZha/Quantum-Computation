classdef SonnetFrequencyStep < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the STEP type of sweep. The sweep will always be
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencyStep(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if nargin == 1
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                obj.StepValue=fscanf(theFid,' %f',1);     % try to read the step value from the file
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencyStep();
        ...
        function aString=toString(obj)
            ...
            aString=['Single Frequency : Frequency=' num2str(obj.StepValue)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StepValue)==1
                aSignature = sprintf('STEP %s\n',obj.StepValue);
            else
                aSignature = sprintf('STEP %.15g\n',obj.StepValue);
            end
