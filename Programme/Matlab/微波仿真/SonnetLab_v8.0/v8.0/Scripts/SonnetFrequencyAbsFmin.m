classdef SonnetFrequencyAbsFmin < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the ABS_FMIN type of sweep. The sweep will always be
    ...
    properties
        ...
        Minimum                   % Minimum is the response that we are searching for
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencyAbsFmin(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % The constructor for a ABS_FMIN SWEEP. The
            ...
            if nargin == 1          % If we were passed 1 argument which means we got the theFid
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                fscanf(theFid,'%s',1);                      % read in the " Net= ", we dont need this in memory
                obj.Minimum=fscanf(theFid,'%s',1);          % read in the Minimum value
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencyAbsFmin();
        ...
        function aString=toString(obj)
            ...
            aString=['ABS Find Minimum : Start Value=' num2str(obj.StartFreqValue) '  End Value=' num2str(obj.EndFreqValue) '  Minimum=' num2str(obj.Minimum)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StartFreqValue)==1
                aSignature = sprintf('ABS_FMIN NET= %s %s',obj.Minimum,obj.StartFreqValue);
            else
                aSignature = sprintf('ABS_FMIN NET= %s %.15g',obj.Minimum,obj.StartFreqValue);
            end
