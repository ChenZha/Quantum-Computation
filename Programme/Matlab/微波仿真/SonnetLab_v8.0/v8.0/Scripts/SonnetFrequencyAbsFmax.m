classdef SonnetFrequencyAbsFmax < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the ABS_FMAX type of sweep. The sweep will always be
    ...
    properties
        ...
        Maximum;                  % Maximum is the response that we are searching for
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencyAbsFmax(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % The constructor for a ABS_FMAX SWEEP. The
            ...
            if nargin == 1           % If we were passed 1 argument which means we got the theFid
                ...
                obj.Maximum=fscanf(theFid,'%s',1);           % read in the maximum value
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencyAbsFmax();
        ...
        function aString=toString(obj)
            ...
            aString=['ABS Find Maximum : Start Value=' num2str(obj.StartFreqValue) '  End Value=' num2str(obj.EndFreqValue) '  Maximum=' num2str(obj.Maximum)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StartFreqValue)==1
                aSignature = sprintf('ABS_FMAX NET= %s %s',obj.Maximum,obj.StartFreqValue);
            else
                aSignature = sprintf('ABS_FMAX NET= %s %.15g',obj.Maximum,obj.StartFreqValue);
            end
