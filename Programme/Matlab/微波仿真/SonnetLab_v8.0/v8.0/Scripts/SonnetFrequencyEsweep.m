classdef SonnetFrequencyEsweep < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the ESWEEP type of sweep. The sweep will always be
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencyEsweep(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % The constructor for a ESWEEP SWEEP. The
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencyEsweep();
        ...
        function aString=toString(obj)
            ...
            aString=['Exponential : Start Value=' num2str(obj.StartFreqValue) '  End Value=' num2str(obj.EndFreqValue) '  # Points=' num2str(obj.AnalysisFrequencies)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StartFreqValue)==1
                aSignature = sprintf('ESWEEP %s',obj.StartFreqValue);
            else
                aSignature = sprintf('ESWEEP %.15g',obj.StartFreqValue);
            end
