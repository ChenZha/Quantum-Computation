classdef SonnetFrequencySimple < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the SIMPLE type of sweep. The sweep will always be
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencySimple(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % The constructor for a SIMPLE SWEEP. The
            ...
            if nargin == 1
                ...
                aTempString = fscanf(theFid,' %f',1);                            % try to read in a step value
                
                if ~isnan(aTempString)                                           % if it exists then assign it, otherwise stick with default
                    obj.StepValue=aTempString;
                end
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencySimple();
        ...
        function aString=toString(obj)
            ...
            aString=['Simple : Start Value=' num2str(obj.StartFreqValue) '  End Value=' num2str(obj.EndFreqValue) '  Step=' num2str(obj.StepValue)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StartFreqValue)==1
                aSignature = sprintf('SIMPLE %s',obj.StartFreqValue);
            else
                aSignature = sprintf('SIMPLE %.15g',obj.StartFreqValue);
            end
