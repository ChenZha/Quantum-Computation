classdef SonnetFrequencyLsweep < handle
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % This class defines the LSWEEP type of sweep. The sweep will always be
    ...
    properties
        ...
        AnalysisFrequencies;        % this value specifies the number of analysis frequencies
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function obj = SonnetFrequencyLsweep(theFid)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % The constructor for a LSWEEP SWEEP. The
            ...
            if nargin == 1
                ...
                obj.AnalysisFrequencies=fscanf(theFid,' %f',1);                      % try to read the step value from the file
        ...
        function aNewObject=clone(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            aNewObject=SonnetFrequencyLsweep();
        ...
        function aString=toString(obj)
            ...
            aString=['Linear (#Points) : Start Value=' num2str(obj.StartFreqValue) '  End Value=' num2str(obj.EndFreqValue) '  # Points=' num2str(obj.AnalysisFrequencies)];
        ...
        function aSignature=stringSignature(obj,theVersion) %#ok<INUSD>
            ...
            if ischar(obj.StartFreqValue)==1
                aSignature = sprintf('LSWEEP %s',obj.StartFreqValue);
            else
                aSignature = sprintf('LSWEEP %.15g',obj.StartFreqValue);
            end
            ...
            if ischar(obj.AnalysisFrequencies)==1
                aSignature = [aSignature sprintf(' %s\n',obj.AnalysisFrequencies)];
            else
