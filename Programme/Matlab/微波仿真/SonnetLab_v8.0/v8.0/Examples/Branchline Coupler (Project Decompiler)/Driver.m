...
% and generate a list of SonnetLab compatible Matlab commands that can be used to create
...
if nargin == 0
    theSonFilename = 'Coupler.son';
end

% Decompile the Sonnet Project file into SonnetLab compatible Matlab commands
