classdef randBenchMarking_multiplexed < qes.measurement.measurement
...
% mail4ywu@gmail.com/mail4ywu@icloud.com
    ...
    methods
        function obj = randBenchMarking_multiplexed(qubits, process, numGates, numShots, noReference)
			if nargin < 5
				noReference = false;
			end
