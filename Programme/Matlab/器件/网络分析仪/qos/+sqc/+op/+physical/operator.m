...
% 				addedZWvDAChnls{ii}.SendWave(DASequence,true,0,0,0);
...
%             end
        ...
        function newobj = Copy(obj)
            ...
            newobj.logSequenceSamples = newobj.logSequenceSamples;
        end
    end
...
%        function obj = mtimes(obj1, obj2)
            ...
            obj.logSequenceSamples = obj.logSequenceSamples | obj1.logSequenceSamples;
...
%                 end
                ...
                if ~isempty(obj1.z_wv{ii})
                    if ~isempty(obj.z_wv{idx})
                        % removed temperoarily, 2018/3/26
%                         obj.z_wv{idx} = obj.z_wv{idx}+obj1.z_wv{ii};
                    else
                        if dln > 0
