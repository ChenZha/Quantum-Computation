function [Phase,Ptomo,datafile]=indCZTomo_Q2_Q12_incircuit(layer)
% [Phase,Ptomo,datafile]=data_taking.ming.sampling.indCZTomo_Q2_Q12_incircuit();
if nargin<1
    layer=1;
end
...
datafile = [path,'\CZTomo_Q2_Q12_',datestr(now,'yymmddTHHMMSS'),'.mat'];
notes = '';
...
if ismember(1,layer)
    ...
    measureType = 'Mptomo';
    check2Qreadout(measureQs,qubits)
    circuitPhase = {'','','','','','','Y2p','Y2p','Y2p','Y2p','Y2p'};
