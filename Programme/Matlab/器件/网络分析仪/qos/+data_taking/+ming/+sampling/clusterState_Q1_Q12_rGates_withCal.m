function [Pxz,Pzx,Pxzz,Pzz]=clusterState_Q1_Q12_rGates_withCal(measureQs,Phase,numRunsPerTake,ms,docali,dosave,numTakes)
...
path=['E:\data\20180622_12bit\sampling\' datestr(now,'yymmdd') '\cluster'];
if ~exist(path)
    mkdir(path)
end
...
GPhase31=sprintf('Rz(%0.6f)',-Phase(1));
GPhase32=sprintf('Rz(%0.6f)',-Phase(2));
GPhase33=sprintf('Rz(%0.6f)',-Phase(3));
GPhase34=sprintf('Rz(%0.6f)',-Phase(4));
GPhase35=sprintf('Rz(%0.6f)',-Phase(5));
GPhase36=sprintf('Rz(%0.6f)',-Phase(6));
GPhase37=sprintf('Rz(%0.6f)',-Phase(7));
GPhase38=sprintf('Rz(%0.6f)',-Phase(8));
GPhase39=sprintf('Rz(%0.6f)',-Phase(9));
GPhase310=sprintf('Rz(%0.6f)',-Phase(10));
GPhase311=sprintf('Rz(%0.6f)',-Phase(11));
GPhase312=sprintf('Rz(%0.6f)',-Phase(12));
GPhase= {GPhase31,GPhase32,GPhase33,GPhase34,GPhase35,GPhase36,GPhase37,GPhase38,GPhase39,GPhase310,GPhase311,GPhase312};
% GPhase = {'','','','','','','','','','','',''};
