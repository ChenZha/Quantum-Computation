function [dipFreqs, pkWithd] = readoutResonator()
% automatic measurement: readout resonator
    ...
    freq = autoConfig.freqRange{1}:autoConfig_r.freqStep:autoConfig.freqRange{2};
   ...
   [pks,locs,w,p] = findpeaks(s21inDb,freq,'SortStr','descend','NPeaks',autoConfig.numDips,...
