...
% data_taking.yulin.sampling.sampling_Q1_Q12_rGates_withCal()

import sqc.util.getQSettings
datafile = ['E:\data\20180216_12bit\sampling\sampling\','sampling_Q1_Q12_',datestr(now,'yymmddTHHMMSS'),'.mat'];
notes = '';
