function indCZTomo_Q2_Q12()
% data_taking.yulin.sampling.indCZTomo_Q2_Q12()

import sqc.util.getQSettings
datafile = ['E:\data\20180216_12bit\sampling\CZTomo\','CZTomo_Q2_Q12_',datestr(now,'yymmddTHHMMSS'),'.mat'];
notes = '';
...
measureType = 'Mphase';
circuitPhase = {'Y2m','','','','','','','','','',''};
[Phase22, ~, ~, ~] = sqc.util.runCircuit([circuitPhase;circuitLayer2],opQs,measureQs,stats,measureType, false);
measureQs = {'q3'};
measureType = 'Mphase';
circuitPhase = {'','Y2m','','','','','','','','',''};
...
'Phase14','Phase17','Phase110',...
'Ptomo45','Ptomo78','Ptomo1011',...
'Phase22','Phase23','Phase26','Phase29','Phase212',...
'Ptomo34','Ptomo67','Ptomo910',...
'Phase32','Phase35','Phase38','Phase311','Phase312');
