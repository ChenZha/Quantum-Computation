function sampling_Q2_Q12_SingleQrGates_withCal()
% data_taking.yulin.sampling.sampling_Q2_Q12_SingleQrGates_withCal()

import sqc.util.getQSettings
datafile = ['E:\data\20180216_12bit\sampling\sampling\','sampling_Q2_Q12_singleQ_',datestr(now,'yymmddTHHMMSS'),'.mat'];
notes = '';
