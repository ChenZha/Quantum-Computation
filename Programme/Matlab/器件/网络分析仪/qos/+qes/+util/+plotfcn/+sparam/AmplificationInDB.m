function [varargout] = AmplificationInDB(Data, SweepVals,ParamNames,MainParam,MeasurementName,AX,IsPreview)
    % plot fonction for S parameter, plot amplitude in DB
