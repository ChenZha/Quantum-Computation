function [EL,SL] = CaFluxQubit(Ej,Ec,alpha,beta,kappa,sigma,Cc,Cr,Csh,FluxBias,nk,nl,nm,nlevels)
% reprogrammming Wu yulin's programme
% example : [EL1,SL1] = CaFluxQubit(148e9,3.29e9,0.613,0,0,0,4.19e-15,150e-15,0,0.5,5,10,2,20);
% 对于Cc带入正常值
% Ej,Ec为频率值,单位为Hz，
% 输出的EL也为频率值，单位为Hz
if nlevels > nk*nl*nm
