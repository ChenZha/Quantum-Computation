...
function spectrumplot(Eca,Eja,Csh,alpha)
%   examclcple:spectrumplot(0.35,43,51,0.43)
    ...
    hold on;
   for i=1:41
       EL=energylevel(Eca,Eja,Csh,alpha,-0.2+(i-1)*0.1/10);
       w1(i)=EL(2)-EL(1);w2(i)=EL(3)-EL(2);w3(i)=EL(3)-EL(1);w4(i)=(EL(3)-EL(1))/2;
   end
   x=-0.2:0.1/10:0.2;
   plot(x,w1,x,w3,':',x,w4,'-.',x,w2,'--');
   xlabel('FluxBias');
   ylabel('频率v/GHz')
end
