...
nm = 2;
nlevels = 4;
Fluxbias = 0.5;%59.5654*0.5/275;
EL = TriJFlxQbtELs(Ej,Ec,alpha,beta,kappa,sigma,Fluxbias,nk,nl,nm,nlevels);
E01 = (EL(3)+EL(4))/2-(EL(1)+EL(2))/2;
end

function EL = TriJFlxQbtELs(Ej,Ec,alpha,beta,kappa,sigma,FluxBias,nk,nl,nm,nlevels)
