...
#print (0.5*g1*g2/(w_q1-w_c)/(w_q2-w_c)*(w_q1-w_c+w_q2-w_c)/(2*np.pi)*1000)
...
#H0= (w_c ) * a.dag() * a + (w_q1) * sm1.dag()*sm1  + g1 * (a * sm1.dag() + a.dag() * sm1)
