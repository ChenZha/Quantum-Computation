...
def CZ_decoherence(P):
    ...
    T = []
    T.append([tensor(basis(3,0),basis(3,0)),tensor(basis(3,0),basis(3,0)),T1,T2])
    T.append([tensor(basis(3,0),basis(3,1)),tensor(basis(3,0),basis(3,1)),T1,T2])
    T.append([tensor(basis(3,1),basis(3,0)),tensor(basis(3,1),basis(3,0)),T1,T2])
    T.append([tensor(basis(3,1),basis(3,1)),-tensor(basis(3,1),basis(3,1)),T1,T2])
...
#    Operator_View(process,'U_Simulation')
    ...
    print(P[0],P[1],np.mean(fid),Ufidelity)
    return(-Ufidelity)
