...
def cy_td_ode_rhs(
    ...
    spmvpy(&data3[0], &idx3[0], &ptr3[0], &vec[0], -3.64424747816/2*(1-np.cos(np.pi/t_rise*t))*(0<=t<=t_rise)+-3.64424747816*(t_rise<t<T_P-t_rise)+-3.64424747816/2*(1+np.cos(np.pi/t_rise*(t-T_P+t_rise)))*(T_P-t_rise<=t<=T_P), out, num_rows)
    spmvpy(&data4[0], &idx4[0], &ptr4[0], &vec[0], -0.69115038379/2*(1-np.cos(np.pi/t_rise*t))*(0<=t<=t_rise)+-0.69115038379*(t_rise<t<T_P-t_rise)+-0.69115038379/2*(1+np.cos(np.pi/t_rise*(t-T_P+t_rise)))*(T_P-t_rise<=t<=T_P), out, num_rows)
    spmvpy(&data5[0], &idx5[0], &ptr5[0], &vec[0], -1.63362817987/2*(1-np.cos(np.pi/t_rise*t))*(0<=t<=t_rise)+-1.63362817987*(t_rise<t<T_P-t_rise)+-1.63362817987/2*(1+np.cos(np.pi/t_rise*(t-T_P+t_rise)))*(T_P-t_rise<=t<=T_P), out, num_rows)
    spmvpy(&data6[0], &idx6[0], &ptr6[0], &vec[0], -2.57610597594/2*(1-np.cos(np.pi/t_rise*t))*(0<=t<=t_rise)+-2.57610597594*(t_rise<t<T_P-t_rise)+-2.57610597594/2*(1+np.cos(np.pi/t_rise*(t-T_P+t_rise)))*(T_P-t_rise<=t<=T_P), out, num_rows)
